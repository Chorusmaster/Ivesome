...
function FiltersCard() {
  return (
    <Card>
      ...
      <div className="font-medium text-body mb-2">Stage</div>
      <div className="flex items-center gap-2">
        <input
          id="team_formation_filter"
          name="team_formation"
          type="checkbox"
      ...
      <div className="font-medium text-body mb-2">Category</div>
      <div className="flex items-center gap-2">
        <input
          id="fintech_filter"
          name="fintech"
