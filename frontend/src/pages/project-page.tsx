          ...
          <div>
            <div className="flex gap-4 mb-1 items-center">
              ...
              <div className="text-muted text-small">
                Published{" "}
                {formatDistanceToNowStrict(new Date("2024-06-01"), {
                  locale: enUS,
                  addSuffix: true,
                })}
              </div>
            ...
            <h1 className="text-display font-heading mb-4 font-sans">
              Nudge — a habit tracker for remote development teams
            </h1>
            <div className="text-text-secondary text-body mb-4">
              A lightweight Slack bot that turns daily stand-ups into quick,
              private habits, complete with team productivity analytics, and
              without any extra meetings.
            </div>
            <Tags list={["productivity", "saas", "b2b"]}></Tags>
          </div>

          <ItemLogo size="lg"></ItemLogo>
        </div>
      </div>
        ...
        <div className="col-span-3 flex flex-col gap-4">
          <Card>
            ...
            <p className="text-text-secondary">
              Nudge is a collaborative habit-building platform designed for
              remote software development teams. Instead of relying on lengthy
              daily stand-ups and manual check-ins, it encourages small,
              consistent actions through lightweight prompts delivered directly
              in Slack. Team members can track personal goals, share progress
              when they choose, and receive gentle reminders without
              interrupting their workflow.
              <br></br>
              <br></br>
              The platform provides managers with anonymized productivity trends
              and engagement insights, helping them identify potential
              bottlenecks while respecting individual privacy. By combining
              habit tracking, asynchronous communication, and actionable
              analytics, Nudge aims to improve team consistency, reduce meeting
              fatigue, and foster healthier work routines for distributed teams.
            </p>
          </Card>
          ...
          <Card>
            <div className="flex flex-col gap-4 justify-center">
              <button className="button text-white bg-primary hover:bg-primary-hover flex gap-2 justify-center items-center">
                <Users></Users> Send participation request
              </button>
              <div className="flex gap-4">
